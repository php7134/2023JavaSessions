...
public class StringMethods {
	...
	public static void main(String[] args) {
		...
		String pop="xXseleniumxXXtestingXxXJavaXxXxpythonX";
		...
		//SubString:
		String messg="your transcation id is 12345";
		...
		String s1="hello This is my java code i am so happy";
		//int z=s1.indexOf('i', s1.indexOf('i')+1);
